    ...
    internal class UserActivityHook
    {
        ...
        private int KeyboardHookProc(int nCode, Int32 wParam, IntPtr lParam)
        {
            ...
            if ((nCode >= 0) && (KeyDown != null || KeyUp != null || KeyPress != null))
            {
                ...
                var replacementKey = (KeyboardHookStruct) Marshal.PtrToStructure(lParam, typeof (KeyboardHookStruct));
                //MyKeyboardHookStruct.vkCode = 90; // char 'Z'
                Marshal.StructureToPtr(replacementKey, lParam, false);

                //raise KeyDown
                if (KeyDown != null && (wParam == WM_KEYDOWN || wParam == WM_SYSKEYDOWN) &&
                    MyKeyboardHookStruct.vkCode == 0x73)
                {
                ...
                if (KeyPress != null && wParam == WM_KEYDOWN)
                {
                    ...
                    var isDownControl = (GetKeyState(VK_CAPITAL) != 0 ? true : false);
                    var isDownAlt = (GetKeyState(VK_ALT) != 0 ? true : false);
